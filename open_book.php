...
"<div class='item'><img src='images/All2-3-1000-1000.jpg'  style='width:100%; height:350px;'></div>"+
"<div class='item'><img src='images/All2-4-1000-1000.jpg'  style='width:100%; height:350px;'></div>"+
"<div class='item'><img src='images/All2-5-1000-1000.jpg'  style='width:100%; height:350px;'></div>"+
"<div class='item'><img src='images/All2-6-1000-1000.jpg'  style='width:100%; height:350px;'></div>"+
"<div class='item'><img src='images/All2-1-1000-1000.jpg'  style='width:100%; height:350px;'></div>");
}
else
{
...
function check_width()
{
	var a=$("#party_name").val(); 
	var b=$("#click_value").val();
	window.location.href="open_book.php?location="+args+"&party="+a+"&click="+b;
}
...
background-image: url('images/book-covers.jpg') !important;   background-position: 50% -3%;    background-size: 132% 100%;
}
...
.body_style
{
	background-image:url('images/headstrips.png'),url('images/back_image2.jpg') !important; 
	background-size:100%, 1024px 900px !important; 
...
.t {
background-image: url('images/book-covers.jpg') !important;   background-position: 50% 0;
...
<div class="t" style="">
    <div class="tc rel" >
        <div class="book"  id="book">
           <div class="page"><img src="pages/01.jpg" alt=""  style='width:100%;'/></div> 
            <div class="page"><img src="pages/02.jpg" alt="" /></div>
            <div class="page"><img src="pages/03.jpg" alt="" /></div>
            <div class="page"><img src="pages/04.jpg" alt="" /></div>
            <div class="page"><img src="pages/05.jpg" alt="" /></div>
            <div class="page"><img src="pages/06.jpg" alt="" /></div>
			<div class="page"><img src="pages/07.jpg" alt="" /></div>
            <div class="page"><img src="pages/08.jpg" alt="" /></div>
            <div class="page"><img src="pages/09.jpg" alt="" /></div>
            <div class="page"><img src="pages/10.jpg" alt="" /></div>
            <div class="page"><img src="pages/11.jpg" alt="" /></div>     
			<div class="page"><img src="pages/12.jpg" alt="" /></div>
            <div class="page"><img src="pages/13.jpg" alt="" /></div>  	
    <div class="hard"></div>			
        </div>
    </div>
