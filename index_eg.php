...
$click_value="05082017";
if(isset($_REQUEST['pubid']))
{
...
function redirect_to(args)
{
	...
	window.location.href="get_price_location.php?location="+args+"&party="+a+"&click_val="+b+"&flag=EG";
}
...
{ 
	background-image:url('images/headstrips.png'); 
...
<div class="col-md-12 header_up " style="">
<center>
<button type="button" class="buy_img btn btn-info btn-lg" id="buy_bow_button" data-toggle="modal" data-target="#myModal">Buy now / للشراء</button>
<!--<button type="button" class="buy_imgv btn btn-info btn-lg"  onclick="check_width()" style='font-size:12px;'>View Book/ ⁠⁠⁠نماذج من الكتببب</button>
-->
</center>
<center><span style="color:#005E7E;"><b>No need Visa and Master card.<br> لاحاجة لاستخدام بطاقة الائتمان الدفع بعد الاستلام</b></span>
...
<div class="col-md-12 header_up" style=" background-image:url('images/bg2.png');">
<center>
<div id="myCarousel" class="carousel slide" style="" data-ride="carousel">
  ...
  <div class="carousel-inner " id="inner_slab" role="listbox">
    ...
    <div class="item active">
      <img src="images/01c.jpg" alt="Chania" style="width:100%; height:400px;" onclick="check_width()">
    </div>
	 <div class="item">
      <img src="images/02c.jpg" alt="Flower" style="width:100%; height:400px;" onclick="check_width()">
    </div>
	 <div class="item">
      <img src="images/03c.jpg" alt="Flower" style="width:100%; height:400px;" onclick="check_width()">
    </div>
    <div class="item">
      <img src="images/04c.jpg" alt="Flower" style="width:100%; height:400px;" onclick="check_width()">
    </div>
...
<!--<center><b><span style="color:#005E7E;">طِفْلُكَ سَرِيع الْقِرَاءةِ أَدِيب الْعِبَارَةِ يَكْتُبُ كَالْْخَطَّاطِ <br>World's best books to teach your kids read and write arabic.</span></b></center>-->
...
<tr><td><span class="head_title">معلم القراءة</span>
<br>
<br>
<img src="../images/about/book01.jpg" class="img-responsive" style="float:right !important;" alt=""/>
</td>
</tr>
<tr>
<td class="table_body">معلّم القراءة<br>
إِعْدَادُ طِفْل سَرِيعِ الْقِرَاءَةِ أَدِيبِ الْعِبَارَةِ<br>
يعلم : القراءة السريعة من خلل الصور والألوان.<br>
يعلم : الحصيلة اللغوية ويزيد الثروة اللفظية.<br>
يعد : القاموس المصوّر الأوّّل في حياة الطفل.<br>
<br>
<br>
<br>
</td>
...
<tr><td>
<span class="head_title">علّم بالقلم

</span>
<br>
<br>
<img src="../images/about/book02.jpg" style="float:right !important;" class="img-responsive" alt=""/> 
</td></tr>
<tr><td class="table_body">يعلم الكتابة من خلال الإعادة على النقاط.<br>
يعلم قواعد خط النسخ بطريقة دقيقة ومبسطة .<br>
ينمي الذوق الجمالي والحس الفني لدى الطفل من خلال الرسوم والتلوين والمتاهات .<br><br>
<br>
<br>
</td></tr>
<tr><td>  <span class="head_title">التهيئة للكتابة
</span>
<br>
<br>
<img src="../images/about/book03.jpg" style="float:right !important;"  class="img-responsive" alt=""/>
</td>
</tr>
<tr>
<td class="table_body">يهيئ للكتابة من خلال الإعادة على النقاط.<br>
يعلم قواعد خط النسخ بطريقة دقيقة ومبسطة .<br>
ينمي الذوق الجمالي والحس الفني لدى الطفل من خلال الرسوم والتلوين والمتاهات<br>
<br>
<br>
</td></tr>
</table>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content modal-popout-bg">
      ...
      <div class="modal-body" style="background-color:none !important;">
	   <h4 class="modal-title" style="font-size:18px; color:#005E7E;"><center><b> التوصيل مجانآ<br>Free Delivery!</b></center></h4>


	
<center>
<!--
	<img src="images/set_1_books.jpeg" class="imgresponsive"><br>
	<button type="button" class="buy_img2 btn btn-info btn-lg bt_types_2" onclick="redirect_to('8')">شراء<br>Buy Now</button>
	<br>
<br>
	<img src="images/set_2_books.jpeg" class="imgresponsive"><br>

	  <button type="button" class="buy_img3 btn btn-info btn-lg bt_types_2" onclick="redirect_to('9')">شراء<br>Buy Now</button>
<br>
<br>
-->
	<img src="images/all_books_egypt.jpeg" class="imgresponsive"><br>
	
	  <button type="button" class="buy_img4 btn btn-info btn-lg bt_types_2" onclick="redirect_to('10')">شراء<br>Buy Now</button>
	  <!--
	  
	 <br>
<br>
	<img src="images/set_3_books.jpeg" class="imgresponsive"><br>
	
	  <button type="button" class="buy_img3 btn btn-info btn-lg bt_types_2" onclick="redirect_to('11')">شراء<br>Buy Now</button>
	  <br>
<br>
	<img src="images/set_4_books.jpeg" class="imgresponsive"><br>
	
	  <button type="button" class="buy_img2 btn btn-info btn-lg bt_types_2" onclick="redirect_to('12')">شراء<br>Buy Now</button>
	-->   
...
<div id="myModal1" class="modal fade new_modal" role="dialog" style="">
  <div class="modal-dialog">

    <!-- Modal content-- height: calc(100vh - 20px);-->
    <div class="modal-content  modal-popout-bg">
