...
function get_data()
{
	...
	window.location.href = "get_sl_success_orders.php?filter_date="+a+"&location="+b;
}
</script>
<style>
.marquee_widths
...
{
$location_filter="a.location=b.id_loc and a.sale_deliver_date like'%".$_REQUEST['filter_date']."%' and a.assign_id=".$login_id." and a.is_deleted=0 and a.hide_flag=0 and a.sale_deliver=1";	
}
else if($location_filter!=0 && $filter_date!="")
{
$location_filter="a.location=b.id_loc and a.sale_deliver_date like'%".$_REQUEST['filter_date']."%' and a.location=".$location_filter." and a.is_deleted=0";		
}
else if($location_filter==0 && $filter_date=="")
{
$location_filter="a.location=b.id_loc and a.assign_id=".$login_id." and a.is_deleted=0 and a.hide_flag=0 and a.sale_deliver=1";		
}
...
{
$query = "select a.*,b.id_loc as loc_id,b.location from sales a , location_price b where a.location=b.id_loc and a.assign_id=".$login_id." and a.is_deleted=0 and a.hide_flag=0 and a.sale_deliver=1";
