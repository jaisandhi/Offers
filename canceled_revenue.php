...
<script>
    ...
    function get_data()
    {
        ...
        window.location.href = "canceled_revenue.php?type=cancelled&filter_month="+a+"&filter_year="+b+"&location="+c+"&user_loc_filter="+d;
    }
</script>
<style>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url="getcanceledrevenue.php?type=cancelled&filter_month="+ans+"&filter_year="+ans1+"&location="+bloc+"&user_loc_filter="+bloc1;
        ...
        $.getJSON(url, function (result) {
            ...
            {
            ?>
            $.getJSON("getcanceledrevenue.php", function (result) {
                <?php
                }
                ?>
...
<!--        <a href="/offers/revenue_reports.php" class="btn btn-success"> Revenue Reports</a>-->
    ...
    <div style=" margin:0px auto; overflow-x:auto;">
        ...
        {
            $val.="<tr><td>".$res['user_name']."</td><td>".$res['location']."</td><td>".$res['canceled']."</td><td>".$res['amount']."</td></tr>";
        }
        ?>
        ...
        <div class='col-md-12'>
            ...
            <table class='table table-bordered table-striped'>
                <thead><tr style='text-align:center'><td>User Name </td><td>Location</td><td>Total Cancelled Count</td><td>Amount</td></tr></thead>
                <?php
                echo $val;
                ?>
            </table>
