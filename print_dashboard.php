...
function get_data()
{
	...
	window.open("print_dashboard_print.php?filter_date="+a+"&location="+b+"&filter_date_to="+c);
}
</script>
<style>
.marquee_widths
...
<div class="col-md-4">	
 ...
 <input type="text" id="to_data"></input>
      <span class="add-on">
        <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
...
{
$location_filter=" a.sale_open_date >= '".$_REQUEST['filter_date']."' and a.sale_open_date  <= '".$_REQUEST['filter_date_to']."' and a.location=b.id_loc and a.is_deleted=0 ";
}
...
<tr><td>Address</td><td style='font-size:12px;'>".$res['address']."</td></tr>
