...
function get_data()
{
	...
	window.location.href = "get_sl_cancelled_orders.php?filter_date="+a+"&location="+b;
}
</script>
<style>
.marquee_widths
...
<b><span style='color:#005E7E;'><br>Select Date:</span></b>
<br>
<br>
...
<br>
<select id="location_filter" style="display:none;">
...
{
$location_filter="a.location=b.id_loc and a.sale_cancel_date like'%".$_REQUEST['filter_date']."%' and a.assign_id=".$login_id." and a.is_deleted=0 and a.hide_flag=0 and a.sale_deliver=2";	
}
else if($location_filter!=0 && $filter_date!="")
{
$location_filter="a.location=b.id_loc and a.sale_cancel_date like'%".$_REQUEST['filter_date']."%' and a.location=".$location_filter." and a.is_deleted=0";		
}
else if($location_filter==0 && $filter_date=="")
{
$location_filter="a.location=b.id_loc and a.assign_id=".$login_id." and a.is_deleted=0 and a.hide_flag=0 and a.sale_deliver=2";		
}
...
{
$query = "select a.*,b.id_loc as loc_id,b.location from sales a , location_price b where a.location=b.id_loc and a.assign_id=".$login_id." and a.is_deleted=0 and a.hide_flag=0 and a.sale_deliver=2";
...
{
$assign_vals=get_loc_names($res['loc_id'],$init_i)."</br><input type='button' class='header_back btn btn-info btn-lg' value='Assign' onclick='form_assign(\"".$res['sales_id']."\",\"assign\",\"".$init_i."\");'/>";
}
else
{
...
<tr><td>Assign </td><td>".$assign_vals."</td></tr>
