...
<center><div class="alert alert-success" style="width:300px;display:none;">
  <strong>Your order is updated!</strong>
</div></center>
...
$query = "select a.*,b.location from sales a , location_price b where a.location=b.id_loc and a.assign_id=".$login_id." and a.is_deleted=0 and a.hide_flag=0 and a.sale_deliver=0";
...
<tr><td colspan='2'><input type='button' class='header_back btn btn-info btn-lg' onclick='form_submit(\"".$res['sales_id']."\",\"successdeliver\");' value='Delivered'/>&nbsp;&nbsp;&nbsp;<input type='button' class='header_back btn btn-info btn-lg' onclick='form_submit(\"".$res['sales_id']."\",\"canceldelivery\")' value='Cancelled' style='".$disp."' /></td></tr>
</table>
</div></br>";
}
?>
