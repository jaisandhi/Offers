...
function get_data()
{
	...
	window.location.href = "get_all_cancel_orders.php?filter_date="+a+"&location="+b;
}
</script>
<style>
.marquee_widths
...
<b><span style="color:#005E7E;"><br>Delivery Cancelled Orders</span></b>
<br>
<br>
...
<br>
<input type="button" value="Submit" onclick="get_data()"/>  <input type="button" value="Refresh" onclick="redirect_cancel_delivery()"/> 
...
{
$location_filter="a.location=b.id_loc and a.sale_cancel_date like'%".$_REQUEST['filter_date']."%' and a.is_deleted=0";	
}
else if($location_filter!=0 && $filter_date!="")
{
...
{
$location_filter="a.location=b.id_loc and a.sale_stat=4 and a.is_deleted=0";		
}
...
{
$query = "select a.*,b.location from sales a , location_price b where a.location=b.id_loc and a.sale_stat=4 and a.is_deleted=0";
}
...
{
echo "
<tr><td>".$res['location']."</td><td>".$res['name']."</td><td>".$res['mobile']."</td><td>".$res['address']."</td><td>".$res['sale_cancel_date']."</td></tr>";
}
echo "</table>";
?>
</div>
