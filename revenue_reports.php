...
<script>
    ...
    function get_data()
    {
        ...
        window.location.href = "revenue_reports.php?filter_month="+a+"&filter_year="+b+"&location="+c;
    }
</script>
<style>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url="getrevenuereports.php?filter_month="+ans+"&filter_year="+ans1+"&location="+bloc;
        ...
        $.getJSON(url, function (result) {
            ...
            {
            ?>
            $.getJSON("getrevenuereports.php", function (result) {
                <?php
                }
                ?>
...
select a.location, count(*) as counts,count(*)*a.price_all AS 'amount' from sales b, location_price a where year(b.created_date) = $filter_date1 and a.id_loc=b.location and b.is_deleted=0 and b.sale_stat!=9 and b.location=10";
        ...
        {
            $val.="<tr><td>".$res['location']."</td><td>".$res['counts']."</td><td>".$res['amount']."</td></tr>";
        }
        ...
        <div class='col-md-12'>
            ...
            <table class='table table-bordered table-striped'>
                <thead><tr style='text-align:center'><td>Location</td><td>Total Orders</td><td>Amount</td></tr></thead>
                <?php
                echo $val;
                ?>
            </table>
